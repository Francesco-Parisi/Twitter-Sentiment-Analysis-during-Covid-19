<template>
    <div class="main">
        <div class="sidebar">
            <button class="link" @click="has=false; viewchart=false">Home</button>
            <button class="link" @click="has=false; dat=false; general()">General</button>
            <button class="link" @click="has=true; dat=false; viewchart=false">By Hashtag</button>
...
.main{
    ...
    .sidebar{
        ...
        font-weight:bold;
        background-image: linear-gradient(to top , #FFFFFF 0%, #FFFFFF 30%, #17a2b8 100%);
        padding-top:0px;
        margin-top:50px;
