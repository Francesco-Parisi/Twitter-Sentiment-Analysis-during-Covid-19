    ...
    methods: {
        general(){
                this.charOptionsBar={            
                    ...
                    height:500,
                    annotationText: {textStyle:  {fontName: 'Calibri',fontSize: 30,bold: true}},
                    legend: {textStyle:  {fontName: 'Calibri',fontSize: 30,bold: true},position:'top'},
                    domain: {textStyle:  {fontName: 'Calibri',fontSize: 30,bold: true}},
