...
export default {
    ...
    methods: {
        general(){
            ...
            let charts=this.$store.getters.getSentimentWeek(3);
        ...
        search(){
            if(this.has){
                ...
                let charts=this.$store.getters.getSentimentByHashtag(this.hashtag,3)
                console.log(charts)
                this.charData= charts.PieChart;
                this.charDataBar= charts.BarChart;
               ...
               let charts=this.$store.getters.getSentimentByData(this.formData.mydate,3)
                 console.log(charts)
                this.charData= charts.PieChart;
                this.charDataBar= charts.BarChart
                this.viewchart=true;
