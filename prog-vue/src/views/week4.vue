...
export default {
    ...
    methods: {
        general(){
            ...
            let charts=this.$store.getters.getSentimentWeek(4);
        ...
        search(){
            if(this.has){
                ...
                let charts=this.$store.getters.getSentimentByHashtag(this.hashtag,4)
                console.log(charts)
                this.charData= charts.PieChart;
                this.charDataBar= charts.BarChart;
               ...
               let charts=this.$store.getters.getSentimentByData(this.formData.mydate,4)
                 console.log(charts)
                this.charData= charts.PieChart;
                this.charDataBar= charts.BarChart
                this.viewchart=true;
