        ...
        <div class="content">
            <div class="search"  v-show="has || dat">
                <div class="data" v-if="dat">
                    <input type="date" v-model="formData.mydate" min="2020-11-19" max="2020-11-25">
...
export default {
    ...
    methods: {
        general(){
            ...
            let charts=this.$store.getters.getSentimentWeek(2);
        ...
        search(){
            if(this.has){
                ...
                let charts=this.$store.getters.getSentimentByHashtag(this.hashtag,2)
                console.log(charts)
                this.charData= charts.PieChart;
                this.charDataBar= charts.BarChart;
               ...
               let charts=this.$store.getters.getSentimentByData(this.formData.mydate,2)
                 console.log(charts)
                this.charData= charts.PieChart;
                this.charDataBar= charts.BarChart
                this.viewchart=true;
